...
import type { ComponentChildren, GenericEventHandler, HTMLAttributes, KeyboardEventHandler, SignalLike } from "preact";
...
export interface EditorProps extends Omit<HTMLAttributes<HTMLDivElement>, "onKeyDown"> {
...
export function Editor(
  ...
  const handleInput: GenericEventHandler<HTMLTextAreaElement> = (evt) => {
