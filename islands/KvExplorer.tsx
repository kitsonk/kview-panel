...
export default function KvExplorer() {
  ...
  function loadKeys() {
    const target = `/api/kv/${keyJsonToPath(currentKey.value)}`;
  ...
  function loadValue() {
    ...
    const target = `/api/kv/${keyJsonToPath(currentEntryKey.value.key)}?${
  ...
  return (
    <>
      ...
      <div class="border rounded p-2">
        ...
        <div class="w-full my-2 md:w-auto flex flex-col md:flex-wrap md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 shrink-0">
          <button
            type="button"
